...
class TweetFeatGenerator():
    ...
    def crawl(self):
        ...
        try:
            ...
            if len(tweets) > 0:
                ...
                raise Exception("No tweets available")
    ...
    def inference_tweets(self):
        ...
        print(f"Type of sample df: {type(sample_df)}")
        
        # Preprocess tweets
        if type(sample_df) == pd.DataFrame:
            ...
            return f"Sample DF is not a DataFrame object.\n{sample_df}"